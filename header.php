...
<nav style="width:100%;background:#1976D2;padding:12px 0 10px 0;margin-bottom:30px;">
    <div style="text-align:center;">
        ...
        <a href="fatturato.php" style="color:#fff;font-weight:bold;font-size:18px;margin:0 20px;<?php if($pagina=='fatturato.php') echo 'text-decoration:underline;'; else echo 'text-decoration:none;'; ?>">Fatturato</a>
    </div>
</nav>
